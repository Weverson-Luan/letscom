...
import { ListPvcCard } from "../list-pvc-card";

export function ListPvcCardTable({
  products,
  offset,
  totalProducts,
  nextPaginate,
  ...
  return (
    <Card>
      <CardHeader className="items-center justify-between">
        <div>
          <CardTitle>Cartão PVC</CardTitle>
          <CardDescription>
            Gerencie seus cartões e visualize quando quiser.
          </CardDescription>
        </div>
        ...
        <Table>
          ...
          <TableBody>
            {products.map((product) => (
              <ListPvcCard key={product.id} product={product} />
            ))}
          </TableBody>
        </Table>
      </CardContent>
