...
import { ShipmentHistory } from "../shipping-history";
    ...
    <Card>
      <CardHeader className="items-center justify-between">
        <div>
          ...
          <CardDescription>
            Gerencie seu histórico de remessas e visualize quando quiser.
          </CardDescription>
        </div>
        ...
        <Table>
          ...
          <TableBody>
            {products.map((product) => (
              <ShipmentHistory key={product.id} product={product} />
            ))}
          </TableBody>
        </Table>
      </CardContent>
