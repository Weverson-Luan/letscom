...
import { SearchRequest } from "../search-requests";
  ...
  return (
    <Card>
      <CardHeader className="items-center justify-between">
        <div>
          <CardTitle> Pesquisar solicitações</CardTitle>
          <CardDescription>
            Gerencie suas solicitações e visualize quando quiser.
          </CardDescription>
        </div>
        ...
        <Table>
          ...
          <TableBody>
            {products.map((product) => (
              <SearchRequest key={product.id} product={product} />
            ))}
          </TableBody>
        </Table>
      </CardContent>
